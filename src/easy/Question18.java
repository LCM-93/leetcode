...
/**
 * @see <a href="https://leetcode-cn.com/leetbook/read/top-interview-questions-easy/xnr003/"/>
 * 实现 strStr() 函数。
 * <p>
...
public class Question18 {
    ...
    public static int strStr(String haystack, String needle) {
        ...
        int a = 0;
        while (a <= (haystack.length() - needle.length())) {
            if (haystack.charAt(a) == needle.charAt(0)) {
                boolean isMatch = true;
                for (int i = 0; i < needle.length(); i++) {
                    if (haystack.charAt(i + a) != needle.charAt(i)) {
                        isMatch = false;
                        break;
                    }
                }
